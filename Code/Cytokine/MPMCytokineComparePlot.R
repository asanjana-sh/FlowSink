...
#' (e.g., Cytokine) across multiple time points. Graphs are constructed using 
...
pheno_file = "../../Data/Raw Data/Cytokine/Normalized Data/Cytokine_cell_type.xlsx"
...
folder_path = "../../Data/Raw Data/Cytokine/Final Cell Assigned Data"
...
svglite(paste("../../Output/", "Graph_", strsplit(file_name_1, "\\.")[[1]][1], ".svg", sep=""), width = 4.5, height = 4.5)
visualizeFilteredGraph_2(vertices_1, edges_1, w_range)
dev.off()
svglite(paste("../../Output/", "Graph_", strsplit(file_name_2, "\\.")[[1]][1], ".svg", sep=""), width = 4.5, height = 4.5)
visualizeFilteredGraph_2(vertices_2, edges_2, w_range)
dev.off()
svglite(paste("../../Output/", "Graph_", strsplit(file_name_3, "\\.")[[1]][1], ".svg", sep=""), width = 4.5, height = 4.5)
visualizeFilteredGraph_2(vertices_3, edges_3, w_range)
dev.off()

svglite(paste("../../Output/", "GraphCompare_1_2.svg", sep=""), width = 6.5, height = 6.5)
...
svglite(paste("../../Output/", "GraphCompare_2_3.svg", sep=""), width = 6.5, height = 6.5)
...
svglite(paste("../../Output/", "GraphCompare_1_3.svg", sep=""), width = 6.5, height = 6.5)
