...
#### folder_path is the path to the panel's final cell type assigned data; this is for Cytokine panel
...
#write.xlsx(ged_mat, "../../Output/ged/Cytokine_GED_matrix.xlsx")
ged_mat = read.xlsx("../../Output/ged/Cytokine_GED_matrix.xlsx", sheet = "Sheet 1")
...
svglite("../../Output/ged/Cytokine_GED_MDS.svg", width = 7, height = 6)
plot(g)
dev.off()
...
group = factor(c(rep("Baseline", 13), rep("After 1 vac", 13), rep("After 3 vac", 13)))

res= PerMANOVA.Simple(d, group, nperm=1)
