...
folder_path = "C:/Users/AbidaSanjanaShemonti/Documents/R Projects/FlowViz/Data/Raw Data/Bcell_2"
for(folder_name in c("TP1", "TP2", "TP3")){
  ...
  for(file in file_list_1){
    ...
    spill_matrix = read.csv(paste(folder_path, "/", "Bcell_2.csv", sep=""))
  ...
  for(file in file_list_2){
    ...
    spill_matrix = read.csv(paste(folder_path, "/", "Bcell_2_2.csv", sep=""))
    spill_matrix = spill_matrix[, 2:ncol(spill_matrix)]
    colnames(spill_matrix) = marker_channels
